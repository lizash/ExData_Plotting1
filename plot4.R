...
# Project 1
# This script prepares plot 4 in png format
# ---------------------------------------------------------------
...
plot(power.df$time, power.df$Voltage, type = 'l',
...
legend("topright", c('Sub_metering_1', 'Sub_metering_2', 'Sub_metering_3'), 
       col = c(1, 2, 4), lty=c(1,1,1), bty = "n")

plot(power.df$time, power.df$Global_reactive_power, type = 'l',
